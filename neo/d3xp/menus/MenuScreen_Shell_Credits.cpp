...
void idMenuScreen_Shell_Credits::SetupCreditList()
{
	...
	creditList.Append( creditInfo_t() );
	creditList.Append( creditInfo_t( 1,	"Engine Programmers"	) );
	creditList.Append( creditInfo_t( 0,	"Forest 'Lordhavoc' Hale"	) );
	creditList.Append( creditInfo_t( 0, "Jeremy Swigart" ) );
	creditList.Append( creditInfo_t( 0, "Ross Tredinnick" ) );
...
void idMenuScreen_Shell_Credits::Update()
{
	...
	if( BindSprite( root ) )
	{
		...
		if( heading != NULL )
		{
			heading->SetText( "#str_swf_credits" );
