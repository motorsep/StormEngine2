...
void idMenuScreen_Shell_Settings::Initialize( idMenuHandler* data )
{
	...
	option.Append( "#str_swf_controls" );	// controls
	menuOptions.Append( option );
	option.Clear();
	option.Append( "#str_swf_game_options" );	// game options
	menuOptions.Append( option );
	option.Clear();
	option.Append( "#str_swf_system" );	// system
	menuOptions.Append( option );
	option.Clear();
	...
	const char* tips[] = { "#str_swf_controls_desc", "#str_swf_game_options_desc", "#str_swf_system_desc", "#str_swf_customize_3d" };
