...
//static const int MAX_PDA_ITEMS = 15; // SS2 note; number of simultaneously visible items on the pda_persons list' same number of itemX instances should be present
static const int MAX_PDA_ITEMS = 5;
