...
void idMenuScreen_Shell_GameOptions::Initialize( idMenuHandler* data )
{
	...
	control = new( TAG_SWF ) idMenuWidget_ControlButton();
	control->SetOptionType( OPTION_SLIDER_TOGGLE );
	control->SetLabel( "#str_swf_autoswitch" );	// Auto Weapon Switch
	...
	control = new( TAG_SWF ) idMenuWidget_ControlButton();
	control->SetOptionType( OPTION_SLIDER_TOGGLE );
	control->SetLabel( "#str_swf_autoreload" );	// Auto Weapon Reload
	...
	control = new( TAG_SWF ) idMenuWidget_ControlButton();
	control->SetOptionType( OPTION_SLIDER_TOGGLE );
	control->SetLabel( "#str_swf_alwaysrun" );	// Always Run
