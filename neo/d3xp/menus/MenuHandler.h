...
enum shellAreas_t
{
	...
	//SHELL_AREA_START, // motorsep 12-21-2014; we don't need Start screen on PC
	SHELL_AREA_ROOT,
	SHELL_AREA_DEV,
	SHELL_AREA_CAMPAIGN,
	SHELL_AREA_LOAD,
...
enum CinematicArea_t
{
	Cinematic_AREA_INVALID = -1,
	Cinematic_AREA_PLAYING,
	Cinematic_NUM_AREAS
};
...
================================================
*/
class idMenuHandler_Cinematic : public idMenuHandler
{
public:
