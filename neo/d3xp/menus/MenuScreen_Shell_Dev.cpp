...
void idMenuScreen_Shell_Dev::Initialize( idMenuHandler* data )
{
	...
	btnBack->SetLabel( "#str_swf_mainmenu" ); // was "MAIN MENU"
...
void idMenuScreen_Shell_Dev::SetupDevOptions()
{
	...
	devOptions.Append( devOption_t( "test_box2", "Test Box room #2" ) );
	devOptions.Append( devOption_t( "testmaps/seemlessteleport", "Seamless Teleport" ) );
	devOptions.Append( devOption_t( "testmaps/items", "Items zoo" ) );
