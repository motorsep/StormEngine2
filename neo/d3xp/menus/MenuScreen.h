	...
	*/
	...
	public:
		enum systemSettingFields_t
		{
			...
			SYSTEM_FIELD_SHADOWMAPQUALITY,
			SYSTEM_FIELD_SHADOWMAPSAMPLES,
			SYSTEM_FIELD_SHADOWMAPDISTANCE,
			SYSTEM_FIELD_SHADOWMAPIMAGESIZE,
			SYSTEM_FIELD_GLOW_ENABLE,
			SYSTEM_FIELD_HDR_ENABLE,
			SYSTEM_FIELD_HIGH_QUALITY_SKY,
			SYSTEM_FIELD_PNG,
			SYSTEM_FIELD_PNG_QUALITY,
			MAX_SYSTEM_FIELDS
		};
	...
	private:
		...
		bool originalHQSky;
		/* Shadow Map Options*/
		bool originalShadowMapEnable;
		int  originalShadowMapImageSize;
		int  originalShadowMapQuality;
		int  originalShadowMapSampleCount;
		float  originalShadowMapDistance;
		
		/* PNG Options*/
		bool originalUsePNG;
		int  originalPNGQuality;
...
private:
	idMenuWidget_ControlList* 	options;
...
private:
	...
	idSWFSpriteInstance* 	tipInfo; // SS2 fix
...
class idMenuScreen_Cinematic : public idMenuScreen
{
public:
