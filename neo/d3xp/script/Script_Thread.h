...
private:
	...
	void						Event_RandomRange( float rangeMin, float rangeMax ) const;
	void						Event_Wrap( float value, float rangeMin, float rangeMax ) const;
	void						Event_Clamp( float value, float rangeMin, float rangeMax ) const;
	void						Event_GetTime();
	...
	void						Event_GetFloor( float number );
	...
	void						Event_CalculateSkyAngles( float skyAngle, float wobbleDegrees, float wobbleSpeed );
	...
	void						Event_PrecacheParticle( const char* particleName ); // motorsep 09-16-2015; allows precaching of particles
	void						Event_PrecacheModelDef( const char* modelDefName ); // motorsep 09-16-2015; allows precaching of models/anims
	void						Event_GetNextEntity( const char* key, const char* value, const idEntity* lastMatch );	// motorsep 10-01-2014; from TDM
