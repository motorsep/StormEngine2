...
idCVar g_gravity(					"g_gravity",				va("%f", DEFAULT_GRAVITY), CVAR_GAME | CVAR_FLOAT, "");
...
idCVar g_showCollisionWorld(		"g_showCollisionWorld",		"0",			CVAR_GAME | CVAR_BOOL, "show collision bboxes for brushes" );
idCVar g_showCollisionModels(		"g_showCollisionModels",	"0",			CVAR_GAME | CVAR_BOOL, "show collision bboxes for models" );
idCVar g_showCollisionTraces(		"g_showCollisionTraces",	"0",			CVAR_GAME | CVAR_BOOL, "" );
idCVar g_maxShowDistance(			"g_maxShowDistance",		"1024",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "distance at which bboxes stop being shown" );
idCVar g_maxShowDistanceWorld(		"g_maxShowDistanceWorld",	"768",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "distance at which bboxes stop being shown" );
...
idCVar pm_walkspeed(				"pm_walkspeed",				"200",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while walking" );
idCVar pm_runspeed(					"pm_runspeed",				"320",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while running" );
idCVar pm_noclipspeed(				"pm_noclipspeed",			"400",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while in noclip" );
...
idCVar pm_normalheight(				"pm_normalheight",			"66",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "height of player's bounding box while standing" );
idCVar pm_normalviewheight(			"pm_normalviewheight",		"60",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "height of player's view while standing" );
...
// RB end
idCVar g_skipViewEffects(			"g_skipViewEffects",		"0",			CVAR_GAME | CVAR_BOOL, "skip damage and other view effects, disable HUD" );
...
idCVar aas_showAll(					"aas_showAll",				"0",			CVAR_GAME | CVAR_BOOL, "Show all AAS areas" );
