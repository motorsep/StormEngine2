...
================
*/
idEntityFx* idEntityFx::StartFx( const char* fx, const idVec3* useOrigin, const idMat3* useAxis, idEntity* ent, bool bind, const idVec3* useDecalDir )
{
	...
	{
		nfx->BindToJoint( ent, nfx->Joint(), BFL_ORIENTED );
