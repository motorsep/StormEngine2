...
const idEventDef AI_AttackMissile( "attackMissile", "sd", 'e' );
...
const idEventDef AI_MoveToPositionFaceEntity( "moveToPositionFaceEntity", "vE" );
...
const idEventDef AI_GetEnemyLastSeenTime( "getEnemyLastSeenTime", NULL, 'd' );
...
const idEventDef AI_AIEjectReloadBrass( "aiEjectReloadBrass" );
const idEventDef AI_AIDodgeLeft( "aiDodgeLeft" );	// ### SR
const idEventDef AI_AIDodgeRight( "aiDodgeRight" );	// ### SR
const idEventDef AI_AIDodgeBack( "aiDodgeBack" );	// ### SR
const idEventDef AI_AIDodgeUp( "aiDodgeUp" );	// ### SR
const idEventDef AI_InitTurret( "initTurret", "ddd", 'd' );
...
EVENT( AI_MoveToPositionFaceEntity,			idAI::Event_MoveToPositionFaceEntity )
...
EVENT( AI_GetEnemyLastSeenTime,				idAI::Event_GetEnemyLastSeenTime )
...
EVENT( AI_AIDodgeLeft,						idAI::Event_AIDodgeLeft )			// #### SR
...
void idAI::Event_CreateMissile( const char* jointname )
{
	...
	if( projectile.GetEntity() )
	{
		...
		{
			projectile.GetEntity()->Bind( this, BFL_ORIENTED );
		}
		else
		{
			projectile.GetEntity()->BindToJoint( this, jointname, BFL_ORIENTED );
		}
	}
...
{
	bool hit = AttackMelee( meleeDefName );
...
/*
=====================
idAI::Event_GetEnemyLastSeenTime
=====================
*/
void idAI::Event_GetEnemyLastSeenTime()
{
	idThread::ReturnInt( lastSeenEnemyTime );
}
...
void idAI::Event_InitTurret( jointHandle_t jointYaw, jointHandle_t jointPitch, jointHandle_t jointBarrel )
{
	...
	idThread::ReturnInt( turretIndex );
}

/*
===============
idAI::Event_SetTurretParms
===============
*/
...
/*
===============
idAI::Event_TurretWithinAimTolerance
===============
*/
