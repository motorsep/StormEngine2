...
public:
	...
	struct entityFlags_s
	{
		...
		bool				bindSnapXform		: 1;	// if true, the bind should clear the local offset when binding
...
public:
	...
	void					Bind( idEntity* master, BindFlags flags );
	void					BindToJoint( idEntity* master, const char* jointname, BindFlags flags );
	void					BindToJoint( idEntity* master, jointHandle_t jointnum, BindFlags flags );
	void					BindToBody( idEntity* master, int bodyId, BindFlags flags );
	void					Unbind();
	bool					IsBound() const;
...
private:
	...
	void					Event_Bind( idEntity* master, float orientated, float snapXform );
	void					Event_BindPosition( idEntity* master, float orientated, float snapXform );
	void					Event_BindToJoint( idEntity* master, const char* jointname, float orientated, float snapXform );
	void					Event_Unbind();
