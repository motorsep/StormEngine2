...
=================
*/
int idFile::ReadWinding( idWinding& winding )
{
	int numPts = 0;
	ReadInt( numPts );
...
=================
*/
int idFile::ReadPlane( idPlane& plane )
{
	idVec4 vec;
	const int res = ReadVec4( vec );
	plane = idPlane( vec );
	return res;
}
...
=================
*/
int idFile::WritePlane( const idPlane& plane )
{
	return WriteVec4( plane.ToVec4() );
}
