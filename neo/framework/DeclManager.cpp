...
public:
	...
	virtual const idDeclModelDef*	FindModelDef( const char* name, bool makeDefault = true );
	virtual const idDeclModelDef*	ModelDefByIndex( int index, bool forceParse = true );
...
void idDeclManagerLocal::Init()
{
	...
	RegisterDeclType( "table2d",			DECL_TABLE2D,		idDeclAllocator<idDeclTable2d> );
...
const idDeclFX* idDeclManagerLocal::FindFx( const char* name, bool makeDefault )
{
	return static_cast<const idDeclFX*>( FindType( DECL_FX, name, makeDefault ) );
}

const idDeclFX* idDeclManagerLocal::FxByIndex( int index, bool forceParse )
{
	return static_cast<const idDeclFX*>( DeclByIndex( DECL_FX, index, forceParse ) );
}

/********************************************************************/

const idDeclParticle* idDeclManagerLocal::FindParticle( const char* name, bool makeDefault )
{
	return static_cast<const idDeclParticle*>( FindType( DECL_PARTICLE, name, makeDefault ) );
}

const idDeclParticle* idDeclManagerLocal::ParticleByIndex( int index, bool forceParse )
{
	return static_cast<const idDeclParticle*>( DeclByIndex( DECL_PARTICLE, index, forceParse ) );
}

/********************************************************************/

const idDeclModelDef* idDeclManagerLocal::FindModelDef( const char* name, bool makeDefault )
{
	return static_cast<const idDeclModelDef*>( FindType( DECL_MODELDEF, name, makeDefault ) );
}

const idDeclModelDef* idDeclManagerLocal::ModelDefByIndex( int index, bool forceParse )
{
	return static_cast<const idDeclModelDef*>( DeclByIndex( DECL_MODELDEF, index, forceParse ) );
}
