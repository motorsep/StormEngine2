...
bool idFrustum::IntersectsBounds( const idBounds &bounds ) const {
	...
	idSwap::Swap( indexPoints[2], indexPoints[3] );
	idSwap::Swap( indexPoints[6], indexPoints[7] );
...
bool idFrustum::IntersectsFrustum( const idFrustum &frustum ) const {
	...
	idSwap::Swap( indexPoints2[2], indexPoints2[3] );
	idSwap::Swap( indexPoints2[6], indexPoints2[7] );

	if ( LocalFrustumIntersectsFrustum( indexPoints2, ( localFrustum2.dNear > 0.0f ) ) ) {
		return true;
	}

	idSwap::Swap( indexPoints1[2], indexPoints1[3] );
	idSwap::Swap( indexPoints1[6], indexPoints1[7] );
