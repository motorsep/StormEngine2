...
/*
================
idList<_type_,_tag_>::First
================
*/
template< typename _type_, memTag_t _tag_ >
ID_INLINE _type_& idList<_type_, _tag_>::First()
{
	return list[0];
}
...
*/
template< typename _type_, memTag_t _tag_ >
ID_INLINE const _type_& idList<_type_, _tag_>::First() const
{
	return list[ 0 ];
}
...
*/
template< typename _type_, memTag_t _tag_ >
ID_INLINE const _type_& idList<_type_, _tag_>::Last() const
{
	return list[ Num() - 1 ];
}
