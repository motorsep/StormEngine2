...
#if 1 //FIX_RADIANT
		// foresthale 2014-05-10: changed session->rw to common->RW()
		common->RW()->DebugSphere( lColor, sphere, 0, true );
		common->RW()->DrawText( va( "%d", i+1 ), vLight->renderLight.origin + idVec3(0,0,5), 0.25f, idVec4(1,1,0,1), refdef->viewaxis, 1, 0, true );
#endif
	}
}
