...
//idCVar idDmapVertexCache::r_showVertexCache("r_showVertexCache", "0", CVAR_INTEGER | CVAR_RENDERER, "");
idCVar idDmapVertexCache::r_vertexBufferMegs("r_vertexBufferMegs", "32", CVAR_INTEGER | CVAR_RENDERER, "");
idCVar idDmapVertexCache::r_useArbBufferRange("r_useArbBufferRange", "1", CVAR_BOOL | CVAR_RENDERER, "use ARB_MapBufferRange for optimization (might be really slow on ATI/AMD depending on hardware and drivers)");
idCVar idDmapVertexCache::r_reuseVertexCacheSooner("r_reuseVertexCacheSooner", "1", CVAR_BOOL | CVAR_RENDERER, "reuse vertex buffers as soon as possible after freeing");

idDmapVertexCache		dmapVertexCache;
...
/*
==============
idDmapVertexCache::ActuallyFree
==============
*/
void idDmapVertexCache::ActuallyFree(dmapVertCache_t *block) {
...
==============
*/
void *idDmapVertexCache::Position(dmapVertCache_t *buffer) {
	if (r_useArbBufferRange.GetBool()) {
...
/*
===========
idDmapVertexCache::Init
===========
*/
void idDmapVertexCache::Init() {
	if (r_useArbBufferRange.GetBool()) {
...
/*
===========
idDmapVertexCache::Shutdown
===========
*/
void idDmapVertexCache::Shutdown() {
	headerAllocator.Shutdown();
}

/*
===========
idDmapVertexCache::Alloc
===========
*/
void idDmapVertexCache::Alloc(void *data, int size, dmapVertCache_t **buffer, bool indexBuffer) {
	if (r_useArbBufferRange.GetBool()) {
...
/*
===========
idDmapVertexCache::Touch
===========
*/
void idDmapVertexCache::Touch(dmapVertCache_t *block) {
	if (!block) {
...
/*
===========
idDmapVertexCache::Free
===========
*/
void idDmapVertexCache::Free(dmapVertCache_t *block) {
	if (!block) {
		return;
	}
...
/*
===========
idDmapVertexCache::AllocFrameTemp
...
/*
===========
idDmapVertexCache::EndFrame
===========
*/
void idDmapVertexCache::EndFrame() {
...
/*
=============
idDmapVertexCache::IsFast

just for gfxinfo printing
=============
*/
bool idDmapVertexCache::IsFast() {
	return true;
}
