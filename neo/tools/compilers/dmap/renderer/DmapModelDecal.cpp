...
==================
*/
void idDmapRenderModelDecal::Free(idDmapRenderModelDecal *decal) {
	delete decal;
}

/*
=================
idDmapRenderModelDecal::CreateProjectionInfo
=================
*/
bool idDmapRenderModelDecal::CreateProjectionInfo(decalProjectionInfo_t &info, const idFixedWinding &winding, const idVec3 &projectionOrigin, const bool parallel, const float fadeDepth, const idMaterial *material, const int startTime) {
...
/*
=================
idDmapRenderModelDecal::AddWinding
=================
*/
void idDmapRenderModelDecal::AddWinding(const idWinding &w, const idMaterial *decalMaterial, const idPlane fadePlanes[2], float fadeDepth, int startTime) {
	int i;
	...
	if (!nextDecal) {
		nextDecal = idDmapRenderModelDecal::Alloc();
	}
...
/*
=================
idDmapRenderModelDecal::AddDepthFadedWinding
=================
*/
...
/*
=================
idDmapRenderModelDecal::CreateDecal
=================
*/
void idDmapRenderModelDecal::CreateDecal(const idDmapRenderModel *model, const decalProjectionInfo_t &localInfo) {
...
/*
=====================
idDmapRenderModelDecal::RemoveFadedDecals
=====================
*/
idDmapRenderModelDecal *idDmapRenderModelDecal::RemoveFadedDecals(idDmapRenderModelDecal *decals, int time) {
...
/*
=====================
idDmapRenderModelDecal::AddDecalDrawSurf
=====================
*/
void idDmapRenderModelDecal::AddDecalDrawSurf(dmapViewEntity_t *space) {
	int i, j, maxTime;
	float f;
	decalInfo_t	decalInfo;
...
/*
====================
idDmapRenderModelDecal::ReadFromDemoFile
====================
*/
void idDmapRenderModelDecal::ReadFromDemoFile(idDemoFile *f) {
	// FIXME: implement
}

/*
====================
idDmapRenderModelDecal::WriteToDemoFile
====================
*/
void idDmapRenderModelDecal::WriteToDemoFile(idDemoFile *f) const {
	// FIXME: implement
}
