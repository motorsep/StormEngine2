...
and light interactions is deferred from idDmapRenderWorldLocal::CreateLightDefInteractions(), but we
...
dmap_tr.viewCount should be bumped before calling, allowing it
...
/*
============
idDmapRenderWorldLocal::DebugCone
...
/*
================
idDmapRenderWorldLocal::DrawTextLength
...
/*
================
idDmapRenderWorldLocal::DrawText
