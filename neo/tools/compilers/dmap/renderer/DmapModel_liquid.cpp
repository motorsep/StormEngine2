...
/*
====================
idDmapRenderModelLiquid::idDmapRenderModelLiquid
====================
*/
idDmapRenderModelLiquid::idDmapRenderModelLiquid() {
	verts_x = 32;
...
/*
====================
idDmapRenderModelLiquid::GenerateSurface
====================
*/
dmapModelSurface_t idDmapRenderModelLiquid::GenerateSurface(float lerp) {
...
/*
====================
idDmapRenderModelLiquid::WaterDrop
====================
*/
void idDmapRenderModelLiquid::WaterDrop(int x, int y, float *page) {
	int		cx, cy;
...
/*
====================
idDmapRenderModelLiquid::IntersectBounds
====================
*/
void idDmapRenderModelLiquid::IntersectBounds(const idBounds &bounds, float displacement) {
	int		cx, cy;
	int		left, top, right, bottom;
	//float	up;
	float	down;
...
/*
====================
idDmapRenderModelLiquid::Reset
====================
*/
void idDmapRenderModelLiquid::Reset() {
	int	i, x, y;
...
/*
====================
idDmapRenderModelLiquid::InitFromFile
====================
*/
void idDmapRenderModelLiquid::InitFromFile(const char *fileName) {
	int				i, x, y;
	idToken			token;
	...
	deformInfo = R_BuildDeformInfoDmap(verts.Num(), verts.Ptr(), tris.Num(), tris.Ptr(), true);
...
/*
====================
idDmapRenderModelLiquid::InstantiateDynamicModel
====================
*/
idDmapRenderModel *idDmapRenderModelLiquid::InstantiateDynamicModel(const struct dmapRenderEntity_s *ent, const struct dmapViewDef_s *view, idDmapRenderModel *cachedModel) {
	...
	dmapModelSurface_t surf = GenerateSurface(lerp);
...
/*
====================
idDmapRenderModelLiquid::IsDynamicModel
====================
*/
dynamicModel_t idDmapRenderModelLiquid::IsDynamicModel() const {
	return DM_CONTINUOUS;
}

/*
====================
idDmapRenderModelLiquid::Bounds
====================
*/
idBounds idDmapRenderModelLiquid::Bounds(const struct dmapRenderEntity_s *ent) const {
