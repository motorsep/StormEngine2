...
#define UNROLL1DMAP(Y) { int _IX; for (_IX=0;_IX<count;_IX++) {Y(_IX);} }
#define UNROLL2DMAP(Y) { int _IX, _NM = count&0xfffffffe; for (_IX=0;_IX<_NM;_IX+=2){Y(_IX+0);Y(_IX+1);} if (_IX < count) {Y(_IX);}}
#define UNROLL4DMAP(Y) { int _IX, _NM = count&0xfffffffc; for (_IX=0;_IX<_NM;_IX+=4){Y(_IX+0);Y(_IX+1);Y(_IX+2);Y(_IX+3);}for(;_IX<count;_IX++){Y(_IX);}}
...
/*
============
idDmapSIMD_Generic::GetName
============
*/
const char * idDmapSIMD_Generic::GetName(void) const {
	return "generic code";
}

/*
============
idDmapSIMD_Generic::Add

dst[i] = constant + src[i];
============
*/
void VPCALL idDmapSIMD_Generic::Add(float *dst, const float constant, const float *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Add(float *dst, const float *src0, const float *src1, const int count) {
...
/*
============
idDmapSIMD_Generic::Sub

dst[i] = constant - src[i];
============
*/
void VPCALL idDmapSIMD_Generic::Sub(float *dst, const float constant, const float *src, const int count) {
	double c = constant;
...
============
*/
void VPCALL idDmapSIMD_Generic::Sub(float *dst, const float *src0, const float *src1, const int count) {
#define OPER(X) dst[(X)] = src0[(X)] - src1[(X)];
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::Mul

dst[i] = constant * src[i];
============
*/
void VPCALL idDmapSIMD_Generic::Mul(float *dst, const float constant, const float *src0, const int count) {
	double c = constant;
...
============
*/
void VPCALL idDmapSIMD_Generic::Mul(float *dst, const float *src0, const float *src1, const int count) {
#define OPER(X) (dst[(X)] = src0[(X)] * src1[(X)])
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::Div

dst[i] = constant / divisor[i];
============
*/
void VPCALL idDmapSIMD_Generic::Div(float *dst, const float constant, const float *divisor, const int count) {
	double c = constant;
...
============
*/
void VPCALL idDmapSIMD_Generic::Div(float *dst, const float *src0, const float *src1, const int count) {
#define OPER(X) (dst[(X)] = src0[(X)] / src1[(X)])
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::MulAdd

dst[i] += constant * src[i];
============
*/
void VPCALL idDmapSIMD_Generic::MulAdd(float *dst, const float constant, const float *src, const int count) {
	double c = constant;
#define OPER(X) (dst[(X)] += c * src[(X)])
	UNROLL4DMAP(OPER)
#undef OPER
...
============
*/
void VPCALL idDmapSIMD_Generic::MulAdd(float *dst, const float *src0, const float *src1, const int count) {
#define OPER(X) (dst[(X)] += src0[(X)] * src1[(X)])
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::MulSub

dst[i] -= constant * src[i];
============
*/
void VPCALL idDmapSIMD_Generic::MulSub(float *dst, const float constant, const float *src, const int count) {
	double c = constant;
#define OPER(X) (dst[(X)] -= c * src[(X)])
	UNROLL4DMAP(OPER)
#undef OPER
...
============
*/
void VPCALL idDmapSIMD_Generic::MulSub(float *dst, const float *src0, const float *src1, const int count) {
#define OPER(X) (dst[(X)] -= src0[(X)] * src1[(X)])
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::Dot

dst[i] = constant * src[i];
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idVec3 &constant, const idVec3 *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idVec3 &constant, const idPlane *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idVec3 &constant, const idDmapDrawVert *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idPlane &constant, const idVec3 *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idPlane &constant, const idPlane *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idPlane &constant, const idDmapDrawVert *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float *dst, const idVec3 *src0, const idVec3 *src1, const int count) {
#define OPER(X) dst[(X)] = src0[(X)] * src1[(X)];
	UNROLL1DMAP(OPER)
#undef OPER
}
...
============
*/
void VPCALL idDmapSIMD_Generic::Dot(float &dot, const float *src1, const float *src2, const int count) {
#if 1
...
/*
============
idDmapSIMD_Generic::CmpGT

dst[i] = src0[i] > constant;
============
*/
void VPCALL idDmapSIMD_Generic::CmpGT(byte *dst, const float *src0, const float constant, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::CmpGT(byte *dst, const byte bitNum, const float *src0, const float constant, const int count) {
...
/*
============
idDmapSIMD_Generic::CmpGE

dst[i] = src0[i] >= constant;
============
*/
void VPCALL idDmapSIMD_Generic::CmpGE(byte *dst, const float *src0, const float constant, const int count) {
#define OPER(X) dst[(X)] = src0[(X)] >= constant;
	UNROLL4DMAP(OPER)
#undef OPER
}
...
============
*/
void VPCALL idDmapSIMD_Generic::CmpGE(byte *dst, const byte bitNum, const float *src0, const float constant, const int count) {
#define OPER(X) dst[(X)] |= ( src0[(X)] >= constant ) << bitNum;
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::CmpLT

dst[i] = src0[i] < constant;
============
*/
void VPCALL idDmapSIMD_Generic::CmpLT(byte *dst, const float *src0, const float constant, const int count) {
#define OPER(X) dst[(X)] = src0[(X)] < constant;
	UNROLL4DMAP(OPER)
#undef OPER
}
...
============
*/
void VPCALL idDmapSIMD_Generic::CmpLT(byte *dst, const byte bitNum, const float *src0, const float constant, const int count) {
#define OPER(X) dst[(X)] |= ( src0[(X)] < constant ) << bitNum;
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::CmpLE

dst[i] = src0[i] <= constant;
============
*/
void VPCALL idDmapSIMD_Generic::CmpLE(byte *dst, const float *src0, const float constant, const int count) {
#define OPER(X) dst[(X)] = src0[(X)] <= constant;
	UNROLL4DMAP(OPER)
#undef OPER
}
...
============
*/
void VPCALL idDmapSIMD_Generic::CmpLE(byte *dst, const byte bitNum, const float *src0, const float constant, const int count) {
#define OPER(X) dst[(X)] |= ( src0[(X)] <= constant ) << bitNum;
	UNROLL4DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::MinMax
============
*/
void VPCALL idDmapSIMD_Generic::MinMax(float &min, float &max, const float *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::MinMax(idVec2 &min, idVec2 &max, const idVec2 *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::MinMax(idVec3 &min, idVec3 &max, const idVec3 *src, const int count) {
...
============
*/
void VPCALL idDmapSIMD_Generic::MinMax(idVec3 &min, idVec3 &max, const idDmapDrawVert *src, const int count) {
	min[0] = min[1] = min[2] = idMath::INFINITY; max[0] = max[1] = max[2] = -idMath::INFINITY;
...
============
*/
void VPCALL idDmapSIMD_Generic::MinMax(idVec3 &min, idVec3 &max, const idDmapDrawVert *src, const int *indexes, const int count) {
	min[0] = min[1] = min[2] = idMath::INFINITY; max[0] = max[1] = max[2] = -idMath::INFINITY;
...
/*
============
idDmapSIMD_Generic::Clamp
============
*/
void VPCALL idDmapSIMD_Generic::Clamp(float *dst, const float *src, const float min, const float max, const int count) {
...
/*
============
idDmapSIMD_Generic::ClampMin
============
*/
void VPCALL idDmapSIMD_Generic::ClampMin(float *dst, const float *src, const float min, const int count) {
...
/*
============
idDmapSIMD_Generic::ClampMax
============
*/
void VPCALL idDmapSIMD_Generic::ClampMax(float *dst, const float *src, const float max, const int count) {
...
/*
================
idDmapSIMD_Generic::Memcpy
================
*/
void VPCALL idDmapSIMD_Generic::Memcpy(void *dst, const void *src, const int count) {
	memcpy(dst, src, count);
}

/*
================
idDmapSIMD_Generic::Memset
================
*/
void VPCALL idDmapSIMD_Generic::Memset(void *dst, const int val, const int count) {
	memset(dst, val, count);
}

/*
============
idDmapSIMD_Generic::Zero16
============
*/
void VPCALL idDmapSIMD_Generic::Zero16(float *dst, const int count) {
	memset(dst, 0, count * sizeof(float));
}

/*
============
idDmapSIMD_Generic::Negate16
============
*/
void VPCALL idDmapSIMD_Generic::Negate16(float *dst, const int count) {
...
/*
============
idDmapSIMD_Generic::Copy16
============
*/
void VPCALL idDmapSIMD_Generic::Copy16(float *dst, const float *src, const int count) {
...
/*
============
idDmapSIMD_Generic::Add16
============
*/
void VPCALL idDmapSIMD_Generic::Add16(float *dst, const float *src1, const float *src2, const int count) {
...
/*
============
idDmapSIMD_Generic::Sub16
============
*/
void VPCALL idDmapSIMD_Generic::Sub16(float *dst, const float *src1, const float *src2, const int count) {
#define OPER(X) dst[(X)] = src1[(X)] - src2[(X)]
	UNROLL1DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::Mul16
============
*/
void VPCALL idDmapSIMD_Generic::Mul16(float *dst, const float *src1, const float constant, const int count) {
...
/*
============
idDmapSIMD_Generic::AddAssign16
============
*/
void VPCALL idDmapSIMD_Generic::AddAssign16(float *dst, const float *src, const int count) {
#define OPER(X) dst[(X)] += src[(X)]
	UNROLL1DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::SubAssign16
============
*/
void VPCALL idDmapSIMD_Generic::SubAssign16(float *dst, const float *src, const int count) {
#define OPER(X) dst[(X)] -= src[(X)]
	UNROLL1DMAP(OPER)
#undef OPER
}
...
/*
============
idDmapSIMD_Generic::MulAssign16
============
*/
void VPCALL idDmapSIMD_Generic::MulAssign16(float *dst, const float constant, const int count) {
...
/*
============
idDmapSIMD_Generic::MatX_MultiplyVecX
============
*/
void VPCALL idDmapSIMD_Generic::MatX_MultiplyVecX(idVecX &dst, const idMatX &mat, const idVecX &vec) {
	int i, j, numRows;
...
/*
============
idDmapSIMD_Generic::MatX_MultiplyAddVecX
============
*/
void VPCALL idDmapSIMD_Generic::MatX_MultiplyAddVecX(idVecX &dst, const idMatX &mat, const idVecX &vec) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idDmapSIMD_Generic::MatX_MultiplySubVecX
============
*/
void VPCALL idDmapSIMD_Generic::MatX_MultiplySubVecX(idVecX &dst, const idMatX &mat, const idVecX &vec) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idDmapSIMD_Generic::MatX_TransposeMultiplyVecX
============
*/
void VPCALL idDmapSIMD_Generic::MatX_TransposeMultiplyVecX(idVecX &dst, const idMatX &mat, const idVecX &vec) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idDmapSIMD_Generic::MatX_TransposeMultiplyAddVecX
============
*/
void VPCALL idDmapSIMD_Generic::MatX_TransposeMultiplyAddVecX(idVecX &dst, const idMatX &mat, const idVecX &vec) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idDmapSIMD_Generic::MatX_TransposeMultiplySubVecX
============
*/
void VPCALL idDmapSIMD_Generic::MatX_TransposeMultiplySubVecX(idVecX &dst, const idMatX &mat, const idVecX &vec) {
	int i, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idDmapSIMD_Generic::MatX_MultiplyMatX
...
============
*/
void VPCALL idDmapSIMD_Generic::MatX_MultiplyMatX(idMatX &dst, const idMatX &m1, const idMatX &m2) {
	int i, j, k, l, n;
	float *dstPtr;
...
/*
============
idDmapSIMD_Generic::MatX_TransposeMultiplyMatX
...
============
*/
void VPCALL idDmapSIMD_Generic::MatX_TransposeMultiplyMatX(idMatX &dst, const idMatX &m1, const idMatX &m2) {
	int i, j, k, l, n;
	float *dstPtr;
	const float *m1Ptr, *m2Ptr;
	double sum;
...
/*
============
idDmapSIMD_Generic::MatX_LowerTriangularSolve
...
============
*/
void VPCALL idDmapSIMD_Generic::MatX_LowerTriangularSolve(const idMatX &L, float *x, const float *b, const int n, int skip) {
#if 1
...
/*
============
idDmapSIMD_Generic::MatX_LowerTriangularSolveTranspose
...
============
*/
void VPCALL idDmapSIMD_Generic::MatX_LowerTriangularSolveTranspose(const idMatX &L, float *x, const float *b, const int n) {
#if 1
...
/*
============
idDmapSIMD_Generic::MatX_LDLTFactor

in-place factorization LDL' of the n * n sub-matrix of mat
the reciprocal of the diagonal elements are stored in invDiag
============
*/
bool VPCALL idDmapSIMD_Generic::MatX_LDLTFactor(idMatX &mat, idVecX &invDiag, const int n) {
#if 1
...
/*
============
idDmapSIMD_Generic::BlendJoints
============
*/
...
/*
============
idDmapSIMD_Generic::ConvertJointQuatsToJointMats
============
*/
...
/*
============
idDmapSIMD_Generic::ConvertJointMatsToJointQuats
============
*/
...
/*
============
idDmapSIMD_Generic::TransformJoints
============
*/
...
/*
============
idDmapSIMD_Generic::UntransformJoints
============
*/
...
/*
============
idDmapSIMD_Generic::TransformVerts
============
*/
void VPCALL idDmapSIMD_Generic::TransformVerts(idDmapDrawVert *verts, const int numVerts, const idJointMat *joints, const idVec4 *weights, const int *index, int numWeights) {
	int i, j;
...
/*
============
idDmapSIMD_Generic::TracePointCull
============
*/
void VPCALL idDmapSIMD_Generic::TracePointCull(byte *cullBits, byte &totalOr, const float radius, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts) {
	int i;
	byte tOr;
...
/*
============
idDmapSIMD_Generic::DecalPointCull
============
*/
...
/*
============
idDmapSIMD_Generic::OverlayPointCull
============
*/
...
/*
============
idDmapSIMD_Generic::DeriveTriPlanes
...
/*
============
idDmapSIMD_Generic::DeriveTangents
...
/*
============
idDmapSIMD_Generic::DeriveUnsmoothedTangents
...
/*
============
idDmapSIMD_Generic::NormalizeTangents
...
============
*/
void VPCALL idDmapSIMD_Generic::NormalizeTangents(idDmapDrawVert *verts, const int numVerts) {
...
/*
============
idDmapSIMD_Generic::CreateShadowCache
============
*/
...
/*
============
idDmapSIMD_Generic::CreateVertexProgramShadowCache
============
*/
int VPCALL idDmapSIMD_Generic::CreateVertexProgramShadowCache(idVec4 *vertexCache, const idDmapDrawVert *verts, const int numVerts) {
	for (int i = 0; i < numVerts; i++) {
		const float *v = verts[i].xyz.ToFloatPtr();
...
/*
============
idDmapSIMD_Generic::UpSamplePCMTo44kHz

Duplicate samples for 44kHz output.
============
*/
void idDmapSIMD_Generic::UpSamplePCMTo44kHz(float *dest, const short *src, const int numSamples, const int kHz, const int numChannels) {
	if (kHz == 11025) {
		if (numChannels == 1) {
...
/*
============
idDmapSIMD_Generic::UpSampleOGGTo44kHz

Duplicate samples for 44kHz output.
============
*/
void idDmapSIMD_Generic::UpSampleOGGTo44kHz(float *dest, const float * const *ogg, const int numSamples, const int kHz, const int numChannels) {
	if (kHz == 11025) {
		if (numChannels == 1) {
			for (int i = 0; i < numSamples; i++) {
...
/*
============
idDmapSIMD_Generic::MixSoundTwoSpeakerMono
============
*/
void VPCALL idDmapSIMD_Generic::MixSoundTwoSpeakerMono(float *mixBuffer, const float *samples, const int numSamples, const float lastV[2], const float currentV[2]) {
	float sL = lastV[0];
	float sR = lastV[1];
...
/*
============
idDmapSIMD_Generic::MixSoundTwoSpeakerStereo
============
*/
void VPCALL idDmapSIMD_Generic::MixSoundTwoSpeakerStereo(float *mixBuffer, const float *samples, const int numSamples, const float lastV[2], const float currentV[2]) {
	float sL = lastV[0];
	float sR = lastV[1];
	float incL = (currentV[0] - lastV[0]) / MIXBUFFER_SAMPLES;
	float incR = (currentV[1] - lastV[1]) / MIXBUFFER_SAMPLES;
...
/*
============
idDmapSIMD_Generic::MixSoundSixSpeakerMono
============
*/
void VPCALL idDmapSIMD_Generic::MixSoundSixSpeakerMono(float *mixBuffer, const float *samples, const int numSamples, const float lastV[6], const float currentV[6]) {
	float sL0 = lastV[0];
	float sL1 = lastV[1];
	float sL2 = lastV[2];
	float sL3 = lastV[3];
...
/*
============
idDmapSIMD_Generic::MixSoundSixSpeakerStereo
============
*/
void VPCALL idDmapSIMD_Generic::MixSoundSixSpeakerStereo(float *mixBuffer, const float *samples, const int numSamples, const float lastV[6], const float currentV[6]) {
	float sL0 = lastV[0];
	float sL1 = lastV[1];
	float sL2 = lastV[2];
	float sL3 = lastV[3];
...
/*
============
idDmapSIMD_Generic::MixedSoundToSamples
============
*/
void VPCALL idDmapSIMD_Generic::MixedSoundToSamples(short *samples, const float *mixBuffer, const int numSamples) {
