...
===========================================================================
*/
#ifndef __MATH_DMAPSIMD_GENERIC_H__
#define __MATH_DMAPSIMD_GENERIC_H__
...
Generic implementation of idDmapSIMDProcessor
...
public:
	...
	virtual void VPCALL Dot(float *dst, const idVec3 &constant, const idDmapDrawVert *src, const int count);
	...
	virtual void VPCALL Dot(float *dst, const idPlane &constant, const idDmapDrawVert *src, const int count);
	...
	virtual	void VPCALL MinMax(idVec3 &min, idVec3 &max, const idDmapDrawVert *src, const int count);
	virtual	void VPCALL MinMax(idVec3 &min, idVec3 &max, const idDmapDrawVert *src, const int *indexes, const int count);
	...
	virtual void VPCALL TransformVerts(idDmapDrawVert *verts, const int numVerts, const idJointMat *joints, const idVec4 *weights, const int *index, const int numWeights);
	virtual void VPCALL TracePointCull(byte *cullBits, byte &totalOr, const float radius, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts);
	virtual void VPCALL DecalPointCull(byte *cullBits, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts);
	virtual void VPCALL OverlayPointCull(byte *cullBits, idVec2 *texCoords, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts);
	virtual void VPCALL DeriveTriPlanes(idPlane *planes, const idDmapDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes);
	virtual void VPCALL DeriveTangents(idPlane *planes, idDmapDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes);
	virtual void VPCALL DeriveUnsmoothedTangents(idDmapDrawVert *verts, const dmapDominantTri_s *dominantTris, const int numVerts);
	virtual void VPCALL NormalizeTangents(idDmapDrawVert *verts, const int numVerts);
	virtual int  VPCALL CreateShadowCache(idVec4 *vertexCache, int *vertRemap, const idVec3 &lightOrigin, const idDmapDrawVert *verts, const int numVerts);
	virtual int  VPCALL CreateVertexProgramShadowCache(idVec4 *vertexCache, const idDmapDrawVert *verts, const int numVerts);
...
#endif /* !__MATH_DMAPSIMD_GENERIC_H__ */
