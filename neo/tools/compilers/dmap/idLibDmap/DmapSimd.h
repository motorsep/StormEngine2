...
===========================================================================
*/
#ifndef __MATH_DMAPSIMD_H__
#define __MATH_DMAPSIMD_H__

struct dmapDominantTri_s;
...
All idDmapSIMDProcessor routines are thread safe.
...
public:
	idDmapSIMDProcessor(void) { cpuid = CPUID_NONE; }
	...
	virtual void VPCALL TransformVerts(idDmapDrawVert *verts, const int numVerts, const idJointMat *joints, const idVec4 *weights, const int *index, const int numWeights) = 0;
	virtual void VPCALL TracePointCull(byte *cullBits, byte &totalOr, const float radius, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts) = 0;
	virtual void VPCALL DecalPointCull(byte *cullBits, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts) = 0;
	virtual void VPCALL OverlayPointCull(byte *cullBits, idVec2 *texCoords, const idPlane *planes, const idDmapDrawVert *verts, const int numVerts) = 0;
	virtual void VPCALL DeriveTriPlanes(idPlane *planes, const idDmapDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes) = 0;
	virtual void VPCALL DeriveTangents(idPlane *planes, idDmapDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes) = 0;
	virtual void VPCALL DeriveUnsmoothedTangents(idDmapDrawVert *verts, const dmapDominantTri_s *dominantTris, const int numVerts) = 0;
...
extern idDmapSIMDProcessor* dmapSIMDProcessor;

#endif /* !__MATH_DMAPSIMD_H__ */
