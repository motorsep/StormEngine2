...
===========================================================================
*/
#ifndef __DMAPSURFACE_H__
#define __DMAPSURFACE_H__
...
public:
	...
	const idDmapDrawVert* 		GetVertices() const
	{
		return verts.Ptr();
	}
...
====================
*/
ID_INLINE idDmapSurface::idDmapSurface()
{
}
...
=================
*/
ID_INLINE void idDmapSurface::Clear()
{
	verts.Clear();
	indexes.Clear();
	edges.Clear();
