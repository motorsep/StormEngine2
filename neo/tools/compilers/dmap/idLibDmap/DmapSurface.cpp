...
=================
*/
int idDmapSurface::Split(const idPlane& plane, const float epsilon, idDmapSurface** front, idDmapSurface** back, int* frontOnPlaneEdges, int* backOnPlaneEdges) const
{
	float* 			dists;
	float			f;
	byte* 			sides;
	...
	*front = *back = NULL;
	...
	if (!counts[SIDE_FRONT] && !counts[SIDE_BACK])
	{
		...
		{
			*back = new(TAG_IDLIB_SURFACE)idDmapSurface(*this);
			return SIDE_BACK;
		}
		else
		{
...
/*
=================
idDmapSurface::ClipInPlace
=================
*/
bool idDmapSurface::ClipInPlace(const idPlane& plane, const float epsilon, const bool keepOn)
{
	float* 			dists;
	float			f;
	byte* 			sides;
...
/*
=============
idDmapSurface::IsConnected
=============
*/
bool idDmapSurface::IsConnected() const
{
...
/*
=================
idDmapSurface::IsClosed
=================
*/
bool idDmapSurface::IsClosed() const
{
...
/*
=============
idDmapSurface::IsPolytope
=============
*/
bool idDmapSurface::IsPolytope(const float epsilon) const
{
	int i, j;
	idPlane plane;
...
/*
=============
idDmapSurface::PlaneDistance
=============
*/
float idDmapSurface::PlaneDistance(const idPlane& plane) const
{
	int		i;
	float	d, min, max;
...
/*
=============
idDmapSurface::PlaneSide
=============
*/
int idDmapSurface::PlaneSide(const idPlane& plane, const float epsilon) const
{
	bool	front, back;
	int		i;
	float	d;
...
/*
=================
idDmapSurface::LineIntersection
=================
*/
...
/*
=================
idDmapSurface::RayIntersection
=================
*/
bool idDmapSurface::RayIntersection(const idVec3& start, const idVec3& dir, float& scale, bool backFaceCull) const
{
...
/*
=================
idDmapSurface::GenerateEdgeIndexes

Assumes each edge is shared by at most two triangles.
=================
*/
void idDmapSurface::GenerateEdgeIndexes()
{
