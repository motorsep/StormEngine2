...
#define SAVEGAME_THUMB_FILENAME				"preview.tga"
#define SAVEGAME_THUMB_WIDTH				256
#define SAVEGAME_THUMB_HEIGHT				144
#define MIN_SAVEGAME_PREVIEW_SIZE_BYTES		( 4 * SAVEGAME_THUMB_WIDTH * SAVEGAME_THUMB_HEIGHT +18)
...
#define SAVEGAME_DETAIL_FIELD_MAP_FILENAME	"mapFileName"
#define SAVEGAME_DETAIL_FIELD_HAS_THUMBNAIL	"hasThumbNail"
...
//#define SAVEGAME_GAME_DIRECTORY_PREFIX         "game-"
#define SAVEGAME_GAME_DIRECTORY_PREFIX     ""
...
public:
	...
	{
		return descriptors.GetString( SAVEGAME_DETAIL_FIELD_MAP_FILENAME, "" );
	}
	bool	GetHasThumbnail() const
	{
		return descriptors.GetBool( SAVEGAME_DETAIL_FIELD_HAS_THUMBNAIL, false );
	}
