...
typedef enum
{
	SS_SUBVIEW = -3,	// original value -3; mirrors, viewscreens, etc
	SS_POOP = -2,
	//SS_GUI = -2,		// guis, original sorting value used in Doom 3 from 2004.
	SS_BAD = -1,
	SS_OPAQUE,			// opaque
	...
	SS_POST_PROCESS = 200	// after a screen copy to texture
} materialSort_t;
