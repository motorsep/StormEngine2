...
public:
	...
	{
		BindShader_Builtin( BUILTIN_HDRDITHER );
	}
	// foresthale 2014-04-08: r_glow
	void	BindShader_HDRDitherWithGlow()
	{
		BindShader_Builtin( BUILTIN_HDRDITHERWITHGLOW );
	}
	// foresthale 2014-04-08: r_glow
	void	BindShader_HDRGlowDownScale()
	{
		BindShader_Builtin( BUILTIN_HDRGLOWDOWNSCALE );
	}
	void	BindShader_HDRGlowBlurDirectional()
	{
...
protected:
	...
	enum
	{
		...
		BUILTIN_HDRDITHER,
		// foresthale 2014-04-08: r_glow
		BUILTIN_HDRDITHERWITHGLOW,
		BUILTIN_HDRGLOWDOWNSCALE,
		BUILTIN_HDRGLOWBLURDIRECTIONAL,
		// RB begin
