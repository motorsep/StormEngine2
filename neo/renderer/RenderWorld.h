...
const int SHADERPARM_SKY_FADE		= 4;
const int SHADERPARM_SKY_X			= 5;
const int SHADERPARM_SKY_Y			= 6;
const int SHADERPARM_SKY_Z			= 7;
...
const int SHADERPARM_BEAM_STARTTIME	= 9;
const int SHADERPARM_BEAM_TILE_S	= 10;
const int SHADERPARM_BEAM_TILE_T	= 11;
const int SHADERPARM_BEAM_END_X		= 12;	// for _beam models
const int SHADERPARM_BEAM_END_Y		= 13;
const int SHADERPARM_BEAM_END_Z		= 14;
const int SHADERPARM_BEAM_WIDTH		= 15;
...
// table parameters
const int TABLEPARM_RED				= 0;
const int TABLEPARM_GREEN			= 0;
const int TABLEPARM_BLUE			= 0;
const int TABLEPARM_ALPHA			= 0;
