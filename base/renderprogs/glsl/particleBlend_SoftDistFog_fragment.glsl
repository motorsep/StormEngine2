...
void main() {
	...
	outColor. a *= ZFeather ( samp0 , screenPos , gl_FragCoord . z , vofi_TexCoord1 . x ) ;
	outColor. a *= GetDistanceFalloff ( fragDepth , vofi_TexCoord2 . x , vofi_TexCoord2 . y ) ;
	outColor. rgb = mix ( outColor. rgb , vofi_TexCoord3 . rgb , saturate ( fragDepth * vofi_TexCoord3 . a ) ) ;
	fo_Color = outColor ;
}