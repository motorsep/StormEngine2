...
void main() {
	...
	shadowTexcoord. xyz =
	vec3 ( dot4 ( modelPosition , _fa_[5 /* rpShadowMatrix0X */] ) ,
	dot4 ( modelPosition , _fa_[6 /* rpShadowMatrix0Y */] ) ,
	dot4 ( modelPosition , _fa_[7 /* rpShadowMatrix0Z */] ) ) /
	dot4 ( modelPosition , _fa_[8 /* rpShadowMatrix0W */] ) ;
	shadowTexcoord. w = 0.0 ;
	float viewZ = - vofi_TexCoord9 . z ;
	if ( viewZ < _fa_[4 /* rpCascadeDistances */] [ 0 ] )
	{
		shadowTexcoord. xyz =
		vec3 ( dot4 ( modelPosition , _fa_[5 /* rpShadowMatrix0X */] ) ,
		dot4 ( modelPosition , _fa_[6 /* rpShadowMatrix0Y */] ) ,
	...
	else if ( viewZ < _fa_[4 /* rpCascadeDistances */] [ 1 ] )
	{
		shadowTexcoord. xyz =
		vec3 ( dot4 ( modelPosition , _fa_[9 /* rpShadowMatrix1X */] ) ,
		dot4 ( modelPosition , _fa_[10 /* rpShadowMatrix1Y */] ) ,
		dot4 ( modelPosition , _fa_[11 /* rpShadowMatrix1Z */] ) ) /
		dot4 ( modelPosition , _fa_[12 /* rpShadowMatrix1W */] ) ;
		shadowTexcoord. w = 1.0 ;
	}
	else if ( viewZ < _fa_[4 /* rpCascadeDistances */] [ 2 ] )
	{
		shadowTexcoord. xyz =
		vec3 ( dot4 ( modelPosition , _fa_[13 /* rpShadowMatrix2X */] ) ,
		dot4 ( modelPosition , _fa_[14 /* rpShadowMatrix2Y */] ) ,
		dot4 ( modelPosition , _fa_[15 /* rpShadowMatrix2Z */] ) ) /
		dot4 ( modelPosition , _fa_[16 /* rpShadowMatrix2W */] ) ;
		shadowTexcoord. w = 2.0 ;
	}
	else if ( viewZ < _fa_[4 /* rpCascadeDistances */] [ 3 ] )
	{
		shadowTexcoord. xyz =
		vec3 ( dot4 ( modelPosition , _fa_[17 /* rpShadowMatrix3X */] ) ,
		dot4 ( modelPosition , _fa_[18 /* rpShadowMatrix3Y */] ) ,
		dot4 ( modelPosition , _fa_[19 /* rpShadowMatrix3Z */] ) ) /
		dot4 ( modelPosition , _fa_[20 /* rpShadowMatrix3W */] ) ;
		shadowTexcoord. w = 3.0 ;
	}
	else
	{
		shadowTexcoord. xyz =
		vec3 ( dot4 ( modelPosition , _fa_[21 /* rpShadowMatrix4X */] ) ,
		dot4 ( modelPosition , _fa_[22 /* rpShadowMatrix4Y */] ) ,
		dot4 ( modelPosition , _fa_[23 /* rpShadowMatrix4Z */] ) ) /
		dot4 ( modelPosition , _fa_[24 /* rpShadowMatrix4W */] ) ;
