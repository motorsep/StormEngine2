...
void main() {
	vec4 modelPosition = in_Position ; if ( _va_[4 /* rpEnableSkinning */] . x > 0.0 ) {
	...
	vofi_TexCoord1 = _va_[5 /* rpUser0 */] ;
	vofi_TexCoord2 = _va_[6 /* rpUser1 */] ;
	vofi_TexCoord3 = _va_[7 /* rpUser2 */] ;
	vofi_Color = saturate ( in_Color ) ;
}